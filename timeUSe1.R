...
#recodification en catégorielles

summary(giac$q1HautonShort)
summary(giac$q1FautonShort)

giac$q1HautonShortR <- giac$q1HautonShort
giac$q1HautonShortR[giac$q1HautonShort %in% c(5:8)] <- "Strong Hautonomy"
giac$q1HautonShortR[giac$q1HautonShort %in% c(9:13)] <- "Medium Hautonomy"
giac$q1HautonShortR[giac$q1HautonShort %in% c(14:20)] <- "Weak Hautonomy"


giac$q1FautonShortR <- giac$q1FautonShort
giac$q1FautonShortR[giac$q1FautonShort %in% c(5:8)] <- "Strong Fautonomy"
giac$q1FautonShortR[giac$q1FautonShort %in% c(9:13)] <- "Medium Fautonomy"
giac$q1FautonShortR[giac$q1FautonShort %in% c(14:20)] <- "Weak Fautonomy"
...
giac$eduH = ifelse(giac$w3h1Q35 == 'universite, ecole polytechnique', "H-High Ed", "H-Low ed")
giac$eduF = ifelse(giac$w3f1Q35 == 'universite, ecole polytechnique', "F-High Ed", "F-Low ed")
...
giac$ageLChild<-as.numeric(giac$AgeLastChild) 




summary( lm( giac$q1FautonShort ~ giac$clusters))
summary( lm( giac$q1FautonShort ~ giac$clusters+giac$eduF+giac$emptauxF+ageLChild))

summary( lm( giac$q1HautonShort ~ giac$clusters))
summary( lm( giac$q1HautonShort ~ giac$clusters+giac$eduF+giac$emptauxF+ageLChild))

#Analyse de correspondance

require(ca)
require(FactoMineR)
varClusAlt<-c("q1FautonShortR","q1FautonShortR","clusters","eduF","eduH","emptauxF","ageLChild")
giac$q1HautonShortR

giac2 <- giac[varClusAlt]
fitExTotal<-MCA(giac2,quali.sup=NULL)





mca1<-PCAmix(,fitExTotal,ndim=2, graph=TRUE)  #rotation avant la virgule est vide car pas de variables métriques, les variables dans netExTotal sont toutes catégorielles.
rot<-PCArot(mca1,2,graph=TRUE)
plot(rot,choice="ind", main="Rotated scores",label=TRUE)
